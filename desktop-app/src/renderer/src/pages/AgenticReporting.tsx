            ...
            <div className="w-72 border-r bg-muted/20 p-4 flex flex-col">
                ...
                {hasData ? (
                    ...
                    >
                        ...
                        <p className="text-sm">拖入或点击上传<br />标准 Excel 提取件</p>
                        <input
                            id="excel-upload"
                            type="file"
                            accept=".xlsx, .xls"
                ...
                <div className="pt-4 border-t space-y-4">
                    <div className="space-y-1">
                        <label className="text-xs font-medium text-muted-foreground px-1">推演视阈 (角色设定)</label>
                        <select
                            value={activeRole}
                    ...
                    <div className="space-y-2">
                        <Button onClick={() => setShowPromptSettings(true)} variant="ghost" className="w-full text-xs h-8 text-muted-foreground hover:text-foreground">
                            ⚙️ 原生指令高阶设定
                        </Button>
                    ...
                    <Card className="w-full max-w-2xl shadow-xl">
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">您可以覆写内置的五维度财务分析基准 Prompt（支持 Markdown 格式）。留空将应用系统默认。</p>
                            </div>
                            <textarea
                                ...
                                placeholder={rolePrompts[activeRole] || "输入您对大模型的推演扮演指令与分析侧重点..."}
                            />
                            <div className="flex justify-between items-center pt-2">
                                ...
                                <div className="space-x-2">
                                    <Button variant="outline" onClick={() => setShowPromptSettings(false)}>取消</Button>
